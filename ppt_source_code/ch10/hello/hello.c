...
static const char __pyx_k_D_Teaching_LessonCourse_Python_P[] = "D:\\Teaching\\@LessonCourse\\Python Programming and Practice\\MyLecture\\pyegs\\ch7\\hello\\hello.pyx";
 ...
 *     print("Hello Cython!")             # <<<<<<<<<<<<<<
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_Hello_Cython) < 0) __PYX_ERR(0, 4, __pyx_L1_error)
 ...
 *     print("Hello Cython!")
 */
  __pyx_codeobj_ = (PyObject*)__Pyx_PyCode_New(0, 0, 0, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_D_Teaching_LessonCourse_Python_P, __pyx_n_s_say_hello, 3, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj_)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
